...
제약/바이오 QA·RA 직무는 규제 동향을 계속 따라가는 일이 업무의 기본이라고 생각했습니다.
그런데 취준생 입장에서 여러 기관 사이트를 매일 하나하나 들어가서 확인하는 건 번거로웠고,
결국 며칠 지나면 흐지부지되더라고요. 그래서 수집과 정리를 자동화해서 그 습관 자체를
지속 가능하게 만들었습니다. 동시에 이 과정에서 Warning Letter·Form 483·회수 사례를
직접 들여다보며 QA·RA 실무에서 다루는 자료와 감각을 미리 익히고 싶었습니다.
